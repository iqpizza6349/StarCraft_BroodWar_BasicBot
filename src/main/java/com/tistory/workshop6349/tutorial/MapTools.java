...
public class MapTools {
    ...
    public void onStart() {
        ...
        m_walkable = new Grid<Boolean>(m_width, m_height, true);
        m_buildable = new Grid<Boolean>(m_width, m_height, false);
        m_depotBuildable = new Grid<Boolean>(m_width, m_height, false);
        m_lastSeen= new Grid<Integer>(m_width, m_height, 0);
    ...
    public void draw() {
        ...
        Main.game.drawTextScreen(10, 5, String.valueOf(white + "Map Legend"));
        Main.game.setTextSize(Text.Size.Default);
        Main.game.drawTextScreen(10, 30, String.valueOf(red + "Red"));
        Main.game.drawTextScreen(60, 30, String.valueOf(white + "Can't walk or build"));
        Main.game.drawTextScreen(10, 45, String.valueOf(green + "Green"));
        Main.game.drawTextScreen(60, 45, String.valueOf(white + "Can't walk or build"));
        Main.game.drawTextScreen(10, 60, String.valueOf(yellow + "YELLOW"));
        Main.game.drawTextScreen(60, 60, String.valueOf(white + "Resource Tile, Can't Build"));
        Main.game.drawTextScreen(10, 75, "Teal:");
        Main.game.drawTextScreen(60, 75, String.valueOf(white + "Can't Build Depot"));
    }
